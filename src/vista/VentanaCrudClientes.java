 ...
 * @author Fanny
 */
public class VentanaCrudClientes extends javax.swing.JInternalFrame {
    ...
    public VentanaCrudClientes(JButton b) {
        initComponents();
        this.b = b;
        cabecera = null;
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel9Layout.createSequentialGroup()
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(jPanel9Layout.createSequentialGroup()
                                            .addComponent(telefono4, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
                                            .addGap(204, 204, 204))
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        Cliente e = controlador.buscar(txtCedulaE.getText());
        if (e != null) {
            int resp = JOptionPane.showConfirmDialog(this, "SEGUR DECESAS ELMINAR AL CLIENTE \n "
    ...
    private void actulizarMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actulizarMActionPerformed
        ...
        if (cont == 5) {
            Cliente x = controlador.buscar(txtCedulaM.getText());
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (cont == 5) {
            Cliente x = controlador.buscar(txtCedula.getText());
            if (x == null) {
                ...
                JOptionPane.showMessageDialog(this, "YA EXISTE UN USUARIO CREADO \n CON ESTE NUMERO DE CEDULA", "CLIENTE", JOptionPane.INFORMATION_MESSAGE);
                txtCedula.setText("");
                txtCedula.setBackground(Color.WHITE);
            }
        } else {
    ...
    private void txtCedulaBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCedulaBKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!txtCedulaB.getText().equals("")) {
                Cliente c = controlador.buscar(txtCedulaB.getText());
                if (c != null) {
    ...
    private void txtCedulaMKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCedulaMKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!txtCedulaM.getText().equals("")) {
                Cliente c = controlador.buscar(txtCedulaM.getText());
                if (c != null) {
    ...
    private void txtCedulaEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCedulaEKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!txtCedulaE.getText().equals("")) {
                Cliente c = controlador.buscar(txtCedulaE.getText());
                if (c != null) {
